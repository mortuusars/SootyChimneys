...
//                drawItemStack(ingredient, guiGraphics, 0, 0, 16, 16, 16);
            }
...
//    private static void drawItemStack(ItemStack itemStack, GuiGraphics guiGraphics, int xOffset, int yOffset, float xScale, float yScale, float zScale) {
...
//        stack.pushPose();
//        stack.mulPoseMatrix(guiGraphics.pose().last().pose());
//        stack.translate(xOffset, yOffset, 100.0F);
