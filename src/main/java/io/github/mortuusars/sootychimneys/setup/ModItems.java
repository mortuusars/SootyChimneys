...
public class ModItems {
    ...
    public static final RegistryObject<BlockItem> MUD_BRICK_CHIMNEY = chimneyBlockItem("mud_brick_chimney",
            () -> new BlockItem(ModBlocks.MUD_BRICK_CHIMNEY.get(), new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final RegistryObject<BlockItem> DIRTY_MUD_BRICK_CHIMNEY = chimneyBlockItem("dirty_mud_brick_chimney",
            () -> new BlockItem(ModBlocks.DIRTY_MUD_BRICK_CHIMNEY.get(), new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
    ...
    private static RegistryObject<BlockItem> chimneyBlockItem(String id, Supplier<BlockItem> blockSupplier){
        RegistryObject<BlockItem> item = Registry.ITEMS.register(id, blockSupplier);
        CHIMNEYS.add(item);
        return item;
    }
}
